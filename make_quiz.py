...
# Reconstruct the full dataframe from the raw text response
data = [
...
df = pd.DataFrame(data, columns=["id", "level_id", "title", "order", "solution_explanation"])

# Save to CSV with correct path
file_path = "data/csv/sample_quiz_lessons.csv"
df.to_csv(file_path, index=False)

print(f"Quiz lessons CSV updated successfully at: {file_path}")
print(f"Generated {len(df)} quiz lessons")
